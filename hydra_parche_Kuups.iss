[Setup]
AppName=HydraTouch
AppVerName=HydraTouchLite 4.0.1 Patch Kuups(100419) I.M. TICF,RCC,DCF,TCF. TT AFG
OutputDir=output\stdTouchLite-4.0.1\Kuups\parche
...
Source: vidal\boka.txt.fet;       DestDir: "{app}\etc"; CopyMode: alwaysoverwrite;
