[Setup]
AppName=HydraTouch
AppVerName=HydraTouchLite 4.0.1 (100226) Belros I.M. TICF,RCC,DCF,TCF. TT AFG
OutputDir=output\stdTouchLite-4.0.1\Belros
...
Source: hydra-background-1024x768_1_belros.jpg; DestDir: "{app}"; CopyMode: alwaysoverwrite
...
Source: belros\*.*;       DestDir: "{app}";  CopyMode: alwaysoverwrite
Source: belros\etc\*.*;       DestDir: "{app}\etc";  CopyMode: alwaysoverwrite
