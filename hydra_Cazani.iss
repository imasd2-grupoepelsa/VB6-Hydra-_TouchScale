[Setup]
AppName=HydraTouch
AppVerName=HydraTouchLite 4.0.1 CAZ (020222) I.M. TICF,RCC,DCF,TCF. TT AFG
OutputDir=output\stdTouchLite-4.0.1_CAZ
...
Source: cazani\hydramulti.exe;         DestDir: "{app}"; CopyMode: alwaysoverwrite;  Components: MULTI; 
...
Source: cazani\etc\*.*;       DestDir: "{app}\etc";  CopyMode: alwaysoverwrite
Source: cazani\*.cfg;           DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: cazani\copiasbbdd.exe;           DestDir: "{app}"; CopyMode: alwaysoverwrite
