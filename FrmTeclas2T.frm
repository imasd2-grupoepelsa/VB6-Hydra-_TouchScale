...
Begin VB.Form FrmTeclas2T 
   ...
   Begin VB.Frame Frame2 
      Appearance      =   0  'Flat
      Caption         =   "Grupos de Teclas/Sección"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox CmbJuego 
         Height          =   315
         ItemData        =   "FrmTeclas2T.frx":0884
         Left            =   2640
         List            =   "FrmTeclas2T.frx":08A6
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   600
         Width           =   1695
      ...
      Begin VB.ComboBox CmbTeclas 
         Height          =   315
         ItemData        =   "FrmTeclas2T.frx":08C8
         Left            =   3240
         List            =   "FrmTeclas2T.frx":08D5
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   240
         Width           =   1092
...
Private Sub CambiarIdioma()
    ...
    Frame2.Caption = CargaCadena(1406) & "/" & CargaCadena(9)    'CargaCadena(714)
...
Private Sub Refresca_Datos()
    ...
    Else
        ...
        Registro.OpenRecordset _
                ("select * from teclas where borrado=false  and tabla=" & CmbJuego.TexT _
               & " and prog_tec='TOUCH' and tran_tecsc10='" & cmbgrupo.TexT & "'")
        '''''''''
        With Registro
            If Not .EOF Then
                .MoveFirst
...
Private Sub CmbNumero_Click()
    ...
    If Not Registro.EOF Then
        ...
        cmbgrupo.TexT = CStr(Registro.Fields("secc_maqui"))
    End If
    'End If
