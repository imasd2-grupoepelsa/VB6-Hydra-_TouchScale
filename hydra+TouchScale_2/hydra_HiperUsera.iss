...
AppName=HydraTouch
;\\\\\\\\\\\\\\\\\\\\\\
;AppVerName=HydraTouchLite HiperUsera 3.6.4 (13/10/2019)
;OutputDir=output\stdTouchLiteHiperUsera364
AppVerName=HydraTouchLite HiperUsera 3.7.8 (08/02/2021)
OutputDir=output\stdTouchLiteHiperUsera378
...
;//////
Source: c:\windows\system32\RCHTXES.DLL;     DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: c:\windows\system32\RICHED32.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
...
Source: c:\windows\system32\ASYCFILT.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: c:\inno_appEPELSA\system\COMCAT.DLL; DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
...
Source: c:\windows\system32\MSVBVM60.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
Source: c:\windows\system32\MSXBSE35.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
...
Source: c:\windows\system32\OLEAUT32.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
Source: c:\windows\system32\OLEPRO32.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
...
Source: c:\windows\system32\STDOLE2.TLB;     DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: c:\windows\system32\MSVCRT40.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: c:\windows\system32\MSRDO20.DLL;     DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
