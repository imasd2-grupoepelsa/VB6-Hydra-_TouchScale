[Setup]
AppName=HydraTouch
AppVerName=HydraTouchLite 4.0.1 Cuevas (070224) I.M. TICF,RCC,DCF,TCF. TT AFG
OutputDir=output\stdTouchLite-401_cuevas
...
Source: grupocuevas\*.*;         DestDir: "{app}"; CopyMode: alwaysoverwrite;
