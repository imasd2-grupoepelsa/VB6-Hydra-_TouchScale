[Setup]
AppName=HydraTouch
AppVerName=HydraTouchLiteSAM 3.5.4 (131118) I.M. TICF,RCC,DCF,TCF
OutputDir=output\stdTouchLiteSAM-3.5.4
...
DefaultDirName={pf}\HydraTouchSAM
...
;Source: tiqahTouchsam.exe;         DestDir: "{app}"; CopyMode: alwaysoverwrite;
...
[Icons]
Name: "{group}\HydraTouch";                                                  Filename: "{app}\hydraTouchsam.exe"; WorkingDir: {app}
Name: "{userdesktop}\HydraTouch";                                            Filename: "{app}\hydraTouchsam.exe"; WorkingDir: {app};   MinVersion: 4,4;        Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\HydraTouch";   Filename: "{app}\hydraTouchsam.exe"; WorkingDir: {app};   MinVersion: 4,4;        Tasks: quicklaunchicon
...
Filename: "{app}\hydratouchsam.exe";            Description: "Launch Hydra";            Flags: nowait postinstall skipifsilent

[Registry]
Root: "HKLM"; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers\"; ValueType: String; ValueName: "{app}\hydratouchsam.exe"; ValueData: "~ WINXPSP3 RUNASADMIN"; Flags: uninsdeletekeyifempty uninsdeletevalue;
...
Root: "HKCU"; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers\"; ValueType: String; ValueName: "{app}\hydratouchsam.exe"; ValueData: "~ WINXPSP3 RUNASADMIN"; Flags: uninsdeletekeyifempty uninsdeletevalue;
...
root: HKCU; Subkey: "Software\Grupoepelsa\hydratouchsam.exe"; Flags: uninsdeletekey
root: HKLM; Subkey: "Software\GrupoEpelsa"; Flags: uninsdeletekeyifempty
root: HKLM; Subkey: "Software\GrupoEpelsa\hydratouchsam.exe"; Flags: uninsdeletekey
root: HKLM; Subkey: "Software\GrupoEpelsa\hydratouchsam.exe\Settings"; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}"; Permissions: users-full
