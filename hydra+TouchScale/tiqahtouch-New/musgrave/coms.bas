        ...
        ''''''''''
                    ...
                    If nLR = 0 Then
                        If Tabla = 0 Or IsNull(Tabla) Then
                            ...
                            CadenadeLog "Hydra:" & "Ticket:" & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                        Else
                            If Tabla = 1 Then
                            'frmmonitor.MostrarDato CargaCadena(1412) & " " & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            CadenadeLog "Hydra:" & "Etiqueta Envasado:" & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            Else
                            'frmmonitor.MostrarDato CargaCadena(1413) & " " & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            CadenadeLog "Hydra:" & "Etiqueta Autoservicio:" & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            End If
                        End If
                    Else
                        If Tabla = 0 Or IsNull(Tabla) Then
                            'frmmonitor.MostrarDato CargaCadena(1414) & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            CadenadeLog "Hydra:" & "Ticket Local:" & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                        Else
                            If Tabla = 1 Then
                            'frmmonitor.MostrarDato CargaCadena(1415) & " " & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            CadenadeLog "Hydra:" & "Etiqueta Envasado Local:" & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            Else
                            'frmmonitor.MostrarDato CargaCadena(1416) & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            CadenadeLog "Hydra:" & "Etiqueta Autoservicio Local:" & Cabecera.Ntiquet & "Scale:" & Cabecera.NBalanza & Cabecera.CadenaEstadoTiquet
                            End If
                        End If
...
Dim sruta As String
    ...
    Set Base = dao.OpenDatabase(App.Path & "\dbase.mdb")
