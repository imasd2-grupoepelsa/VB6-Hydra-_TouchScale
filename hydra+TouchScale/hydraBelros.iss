...
AppVerName=HydraTouchLite 3.6.7-1 (191119) Belros I.M. TICF,RCC,DCF,TCF. TT AFG
OutputDir=output\stdTouchLite-3.6.7-1\Belros
;//////////////////////
...
;Source: parkers\*.*;       DestDir: "{app}";  CopyMode: alwaysoverwrite
;//////
