...
Begin VB.Form Form1 
   Caption         =   "Procesos by ThePirat 2004"
   ClientHeight    =   8100
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9315
...
If MSFlexGrid1.Col < 2 Then MsgBox colEjecutable.Item(MSFlexGrid1.TextMatrix(MSFlexGrid1.Row, 0)), vbInformation, "Ruta del ejecutable"
End Sub
