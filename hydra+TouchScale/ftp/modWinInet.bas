...
Public Const INTERNET_FLAG_ACTIVE = &H8000000
...
Public Declare Function InternetWriteFile Lib "wininet.dll" (ByVal hFile As Long, ByVal sBuffer As String, _
        ByVal lNumberOfBytesToRead As Long, _
        lNumberOfBytesRead As Long) As Integer
        
Public Declare Function FtpOpenFileSize Lib "wininet.dll" Alias "FtpOpenFileA" _
