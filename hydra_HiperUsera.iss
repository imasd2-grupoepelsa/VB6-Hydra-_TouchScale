[Setup]
AppName=HydraTouch
AppVerName=HydraTouchLite HiperUsera 4.0.1 (10/02/2026)
OutputDir=output\stdTouchLiteHiperUsera401
...
Source: hiperusera\balusera.dat.fia;       DestDir: "{app}\etc";  CopyMode: alwaysoverwrite
...
Source: support\RCHTXES.DLL;     DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: support\RICHED32.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
...
Source: support\ASYCFILT.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: support\COMCAT.DLL; DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
...
Source: support\MSVBVM60.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
Source: support\MSXBSE35.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
...
Source: support\OLEAUT32.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
Source: support\OLEPRO32.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
...
Source: support\STDOLE2.TLB;     DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: support\MSVCRT40.DLL;    DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile
Source: support\MSRDO20.DLL;     DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: allowunsafefiles restartreplace uninsneveruninstall sharedfile regserver
